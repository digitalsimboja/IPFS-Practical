...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    /**
     * @dev ERC721 constructor takes in a `name` and a `symbol` to the the token collection.
        ...
        returns (string memory)
    {
        ...
        // Here it  checks if the length of the baseURI is greater than 0, if it is, it returns the baseURI and attach
